...
This document outlines the security practices, built-in protections, and deployment guidance for `axum-gate` v1.1.1.
...
### Available Feature Flags (v1.1.1)
...
[dev-dependencies]
axum-gate = { version = "1.1.1", features = ["storage-surrealdb"] }
```
...
**Stay Secure**: `axum-gate` v1.1.1 provides a robust security foundation with production-ready features. Defense-in-depth requires combining it with proper infrastructure hardening, monitoring, and operational security practices.
